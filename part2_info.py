{'pathmnist': {'python_class': 'PathMNIST',
               ...
               'MD5': 'a8b06965200029087d5bd730944a56c1', 'task': 'multi-class',
               'label': {'0': 'adipose', '1': 'background', '2': 'debris', '3': 'lymphocytes', '4': 'mucus',
                         '5': 'smooth muscle', '6': 'normal colon mucosa', '7': 'cancer-associated stroma',
                         '8': 'colorectal adenocarcinoma epithelium'}, 'n_channels': 3,
               'n_samples': {'train': 89996, 'val': 10004, 'test': 7180}, 'license': 'CC BY 4.0'},
 'chestmnist': {'python_class': 'ChestMNIST',
                ...
                'MD5': '02c8a6516a18b556561a56cbdd36c4a8', 'task': 'multi-label, binary-class',
                'label': {'0': 'atelectasis', '1': 'cardiomegaly', '2': 'effusion', '3': 'infiltration', '4': 'mass',
                          '5': 'nodule', '6': 'pneumonia', '7': 'pneumothorax', '8': 'consolidation', '9': 'edema',
                          '10': 'emphysema', '11': 'fibrosis', '12': 'pleural', '13': 'hernia'}, 'n_channels': 1,
                'n_samples': {'train': 78468, 'val': 11219, 'test': 22433}, 'license': 'CC0 1.0'},
 'dermamnist': {'python_class': 'DermaMNIST',
                ...
                'MD5': '0744692d530f8e62ec473284d019b0c7', 'task': 'multi-class',
                'label': {'0': 'actinic keratoses and intraepithelial carcinoma', '1': 'basal cell carcinoma',
                          '2': 'benign keratosis-like lesions', '3': 'dermatofibroma', '4': 'melanoma',
                          '5': 'melanocytic nevi', '6': 'vascular lesions'}, 'n_channels': 3,
                'n_samples': {'train': 7007, 'val': 1003, 'test': 2005}, 'license': 'CC BY-NC 4.0'},
 'octmnist': {'python_class': 'OCTMNIST',
              ...
              'MD5': 'c68d92d5b585d8d81f7112f81e2d0842', 'task': 'multi-class',
              'label': {'0': 'choroidal neovascularization', '1': 'diabetic macular edema', '2': 'drusen',
                        '3': 'normal'}, 'n_channels': 1, 'n_samples': {'train': 97477, 'val': 10832, 'test': 1000},
              'license': 'CC BY 4.0'},
 'pneumoniamnist': {'python_class': 'PneumoniaMNIST',
              ...
              'task': 'binary-class',
              'label': {'0': 'normal', '1': 'pneumonia'}, 'n_channels': 1,
 ...
 'retinamnist': {'python_class': 'RetinaMNIST',
                 ...
                 'MD5': 'bd4c0672f1bba3e3a89f0e4e876791e4', 'task': 'ordinal-regression',
                 'label': {'0': '0', '1': '1', '2': '2', '3': '3', '4': '4'}, 'n_channels': 3,
                 'n_samples': {'train': 1080, 'val': 120, 'test': 400}, 'license': 'CC BY 4.0'},
 'breastmnist': {'python_class': 'BreastMNIST',
                 ...
                 'MD5': '750601b1f35ba3300ea97c75c52ff8f6', 'task': 'binary-class',
                 'label': {'0': 'malignant', '1': 'normal, benign'}, 'n_channels': 1,
                 'n_samples': {'train': 546, 'val': 78, 'test': 156}, 'license': 'CC BY 4.0'},
 'bloodmnist': {'python_class': 'BloodMNIST',
                ...
                'MD5': '7053d0359d879ad8a5505303e11de1dc', 'task': 'multi-class',
                'label': {'0': 'basophil', '1': 'eosinophil', '2': 'erythroblast', '3': 'ig', '4': 'lymphocyte',
                          '5': 'monocyte', '6': 'neutrophil', '7': 'platelet'}, 'n_channels': 3,
                'n_samples': {'train': 11959, 'val': 1712, 'test': 3421}, 'license': 'CC BY 4.0'},
 'tissuemnist': {'python_class': 'TissueMNIST',
                 ...
                 'MD5': 'ebe78ee8b05294063de985d821c1c34b', 'task': 'multi-class',
                 'label': {'0': 'Collecting Duct, Connecting Tubule', '1': 'Distal Convoluted Tubule',
                           '2': 'Glomerular endothelial cells', '3': 'Interstitial endothelial cells',
                           '4': 'Leukocytes', '5': 'Podocytes', '6': 'Proximal Tubule Segments',
                           '7': 'Thick Ascending Limb'}, 'n_channels': 1,
                 'n_samples': {'train': 165466, 'val': 23640, 'test': 47280}, 'license': 'CC BY 3.0'},
 'organamnist': {'python_class': 'OrganAMNIST',
                 ...
                 'MD5': '866b832ed4eeba67bfb9edee1d5544e6', 'task': 'multi-class',
                 'label': {'0': 'bladder', '1': 'femur-left', '2': 'femur-right', '3': 'heart', '4': 'kidney-left',
                           '5': 'kidney-right', '6': 'liver', '7': 'lung-left', '8': 'lung-right', '9': 'pancreas',
                           '10': 'spleen'}, 'n_channels': 1, 'n_samples': {'train': 34581, 'val': 6491, 'test': 17778},
                 'license': 'CC BY 4.0'},
 'organcmnist': {'python_class': 'OrganCMNIST',
                  ...
                  'task': 'multi-class',
                  'label': {'0': 'bladder', '1': 'femur-left',
                            '2': 'femur-right', '3': 'heart',
                            '4': 'kidney-left', '5': 'kidney-right',
                            '6': 'liver', '7': 'lung-left', '8': 'lung-right',
                            '9': 'pancreas', '10': 'spleen'}, 'n_channels': 1,
 ...
 'organsmnist': {'python_class': 'OrganSMNIST',
                 ...
                 'MD5': 'e5c39f1af030238290b9557d9503af9d', 'task': 'multi-class',
                 'label': {'0': 'bladder', '1': 'femur-left', '2': 'femur-right', '3': 'heart', '4': 'kidney-left',
                           '5': 'kidney-right', '6': 'liver', '7': 'lung-left', '8': 'lung-right', '9': 'pancreas',
                           '10': 'spleen'}, 'n_channels': 1, 'n_samples': {'train': 13940, 'val': 2452, 'test': 8829},
                 'license': 'CC BY 4.0'},
 'organmnist3d': {'python_class': 'OrganMNIST3D',
               ...
               'task': 'multi-class',
               'label': {'0': 'liver', '1': 'kidney-right',
                         '2': 'kidney-left', '3': 'femur-right',
                         '4': 'femur-left', '5': 'bladder', '6': 'heart',
                         '7': 'lung-right', '8': 'lung-left', '9': 'spleen',
                         '10': 'pancreas'}, 'n_channels': 1,
 ...
 'nodulemnist3d': {'python_class': 'NoduleMNIST3D',
                   ...
                   'MD5': '902d495e3d91ad1a7bcac1a6b58a8fa2', 'task': 'binary-class',
                   'label': {'0': 'benign', '1': 'malignant'}, 'n_channels': 1,
                   'n_samples': {'train': 1158, 'val': 165, 'test': 526}, 'license': 'CC BY 3.0'},
 'adrenalmnist3d': {'python_class': 'AdrenalMNIST3D',
                    ...
                    'MD5': 'bbd3c5a5576322bc4cdfea780653b1ce', 'task': 'binary-class',
                    'label': {'0': 'normal', '1': 'hyperplasia'}, 'n_channels': 1,
                    'n_samples': {'train': 1188, 'val': 98, 'test': 298}, 'license': 'CC BY 4.0'},
 'fracturemnist3d': {'python_class': 'FractureMNIST3D',
                     ...
                     'MD5': '6aa7b0143a6b42da40027a9dda61302f', 'task': 'multi-class',
                     'label': {'0': 'buckle rib fracture', '1': 'nondisplaced rib fracture',
                               '2': 'displaced rib fracture'}, 'n_channels': 1,
                     'n_samples': {'train': 1027, 'val': 103, 'test': 240}, 'license': 'CC BY-NC 4.0'},
 'vesselmnist3d': {'python_class': 'VesselMNIST3D',
                   ...
                   'MD5': '2ba5b80617d705141f3f85627108fce8', 'task': 'binary-class',
                   'label': {'0': 'vessel', '1': 'aneurysm'}, 'n_channels': 1,
                   'n_samples': {'train': 1335, 'val': 192, 'test': 382}, 'license': 'CC0 1.0'},
 'synapsemnist3d': {'python_class': 'SynapseMNIST3D',
                    ...
                    'MD5': '1235b78a3cd6280881dd7850a78eadb6', 'task': 'binary-class',
                    'label': {'0': 'inhibitory synapse', '1': 'excitatory synapse'}, 'n_channels': 1,
                    'n_samples': {'train': 1230, 'val': 177, 'test': 352}, 'license': 'CC BY 4.0'}}
